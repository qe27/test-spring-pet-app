...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<Long, Map<String, Object>> producerJsonFactory() {
    ...
    @Bean
    public KafkaTemplate<Long, Map<String, Object>> kafkaJsonTemplate() {
        KafkaTemplate<Long, Map<String, Object>> template = new KafkaTemplate<>(producerJsonFactory());
